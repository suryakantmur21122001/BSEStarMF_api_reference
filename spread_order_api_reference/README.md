...
Some important parameters used in the SPREAD API request:
...
These parameters help identify the client, scheme, transaction type, redemption and purchase details, and authentication credentials.
...
This folder provides a structured explanation and Python reference implementation to help developers understand the request structure, response format, and required parameters for successful SPREAD order execution.
